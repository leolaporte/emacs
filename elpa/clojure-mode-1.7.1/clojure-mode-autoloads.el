...
(autoload 'clojure-enable-slime-on-existing-buffers "clojure-mode" nil t nil)

(add-hook 'slime-connected-hook 'clojure-enable-slime-on-existing-buffers)

(add-to-list 'auto-mode-alist '("\\.clj$" . clojure-mode))

(register-definition-prefixes "clojure-mode" '("clojure-" "define-clojure-indent" "put-clojure-indent"))
