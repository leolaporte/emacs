...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2023-07-03 19:47:16" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2023-07-03 19:47:16" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2023-07-03 19:47:16" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2023-07-03 19:47:16" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2023-07-03 19:47:16" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2023-07-03 19:47:16" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2023-07-03 19:47:16" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "use-package" ("2023-07-03 19:47:17" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2023-07-03 19:47:17" ("emacs") (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "org" ("2023-07-03 19:47:17" ("emacs") (:type git :repo "https://git.savannah.gnu.org/git/emacs/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*")) :package "org")) "org-roam" ("2023-07-03 19:47:17" ("emacs" "dash" "org" "emacsql" "magit-section") (:type git :flavor melpa :files (:defaults "extensions/*" "org-roam-pkg.el") :host github :repo "org-roam/org-roam" :package "org-roam" :local-repo "org-roam")) "dash" ("2023-07-03 19:47:17" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "emacsql" ("2023-07-03 19:47:17" ("emacs") (:type git :flavor melpa :files (:defaults "sqlite" "emacsql-pkg.el") :host github :repo "magit/emacsql" :package "emacsql" :local-repo "emacsql")) "magit-section" ("2023-07-03 19:47:17" ("emacs" "compat" "dash") (:type git :flavor melpa :files ("lisp/magit-section.el" "lisp/magit-section-pkg.el" "docs/magit-section.texi" "Documentation/magit-section.texi" "magit-section-pkg.el") :host github :repo "magit/magit" :package "magit-section" :local-repo "magit")) "compat" ("2023-07-03 19:47:17" ("emacs" "seq") (:type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git")) :package "compat" :local-repo "compat")) "deft" ("2023-07-03 19:47:17" nil (:type git :flavor melpa :host github :repo "jrblevin/deft" :package "deft" :local-repo "deft")) "vertico" ("2023-07-03 19:47:19" ("emacs" "compat") (:files (:defaults "extensions/*") :repo "emacs-straight/vertico" :host github :package "vertico" :type git :local-repo "vertico")) "orderless" ("2023-07-03 19:47:19" ("emacs") (:type git :flavor melpa :host github :repo "oantolin/orderless" :package "orderless" :local-repo "orderless")) "embark" ("2023-07-03 19:47:19" ("emacs" "compat") (:type git :flavor melpa :files ("embark.el" "embark-org.el" "embark.texi" "embark-pkg.el") :host github :repo "oantolin/embark" :package "embark" :local-repo "embark")) "embark-consult" ("2023-07-03 19:47:19" ("emacs" "embark" "consult") (:flavor melpa :files ("embark-consult.el" "embark-consult-pkg.el") :package "embark-consult" :local-repo "embark" :type git :repo "oantolin/embark" :host github)) "consult" ("2023-07-03 19:47:19" ("emacs" "compat") (:type git :flavor melpa :host github :repo "minad/consult" :package "consult" :local-repo "consult")) "marginalia" ("2023-07-03 19:47:19" ("emacs" "compat") (:type git :flavor melpa :host github :repo "minad/marginalia" :package "marginalia" :local-repo "marginalia")) "corfu" ("2023-07-03 19:47:19" ("emacs" "compat") (:type git :host github :repo "emacs-straight/corfu" :files ("*" (:exclude ".git")) :package "corfu" :local-repo "corfu")) "magit" ("2023-07-03 19:47:19" ("emacs" "compat" "dash" "git-commit" "magit-section" "transient" "with-editor") (:flavor melpa :files ("lisp/magit*.el" "lisp/git-rebase.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" "Documentation/magit.texi" "Documentation/AUTHORS.md" (:exclude "lisp/magit-libgit.el" "lisp/magit-libgit-pkg.el" "lisp/magit-section.el" "lisp/magit-section-pkg.el") "magit-pkg.el") :package "magit" :local-repo "magit" :type git :repo "magit/magit" :host github)) "git-commit" ("2023-07-03 19:47:19" ("emacs" "compat" "transient" "with-editor") (:flavor melpa :files ("lisp/git-commit.el" "lisp/git-commit-pkg.el" "git-commit-pkg.el") :package "git-commit" :local-repo "magit" :type git :repo "magit/magit" :host github)) "transient" ("2023-07-03 19:47:19" ("emacs" "compat") (:type git :flavor melpa :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2023-07-03 19:47:19" ("emacs" "compat") (:type git :flavor melpa :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "vterm" ("2023-07-03 19:47:19" ("emacs") (:type git :flavor melpa :files ("CMakeLists.txt" "elisp.c" "elisp.h" "emacs-module.h" "etc" "utf8.c" "utf8.h" "vterm.el" "vterm-module.c" "vterm-module.h" "vterm-pkg.el") :host github :repo "akermu/emacs-libvterm" :package "vterm" :local-repo "emacs-libvterm")) "osx-lib" ("2023-07-03 19:47:19" ("emacs") (:type git :flavor melpa :host github :repo "raghavgautam/osx-lib" :package "osx-lib" :local-repo "osx-lib")) "projectile" ("2023-07-03 19:47:19" ("emacs") (:type git :flavor melpa :host github :repo "bbatsov/projectile" :package "projectile" :local-repo "projectile")) "racket-mode" ("2023-07-03 19:47:19" ("emacs") (:type git :flavor melpa :files (:defaults "*.rkt" ("racket" "racket/*") (:exclude "racket/example/*" "racket/test/*") "racket-mode-pkg.el") :host github :repo "greghendershott/racket-mode" :package "racket-mode" :local-repo "racket-mode")) "sly" ("2023-07-03 19:47:19" ("emacs") (:type git :flavor melpa :files (:defaults "lib" "slynk" "contrib" "doc/images" (:exclude "sly-autoloads.el") "sly-pkg.el") :host github :repo "joaotavora/sly" :package "sly" :local-repo "sly")) "auto-complete" ("2023-07-03 19:47:19" ("popup" "cl-lib") (:type git :flavor melpa :files ("*.el" "dict" "auto-complete-pkg.el") :host github :repo "auto-complete/auto-complete" :package "auto-complete" :local-repo "auto-complete")) "popup" ("2023-07-03 19:47:19" ("emacs") (:type git :flavor melpa :host github :repo "auto-complete/popup-el" :package "popup" :local-repo "popup-el")) "ac-sly" ("2023-07-03 19:47:19" ("sly" "auto-complete" "cl-lib") (:type git :flavor melpa :host github :repo "qoocku/ac-sly" :package "ac-sly" :local-repo "ac-sly")) "smartparens" ("2023-07-03 19:47:19" ("dash" "cl-lib") (:type git :flavor melpa :host github :repo "Fuco1/smartparens" :package "smartparens" :local-repo "smartparens")) "rainbow-delimiters" ("2023-07-03 19:47:19" nil (:type git :flavor melpa :host github :repo "Fanael/rainbow-delimiters" :package "rainbow-delimiters" :local-repo "rainbow-delimiters")) "w3m" ("2023-07-03 19:47:19" nil (:type git :flavor melpa :files (:defaults "icons" (:exclude "octet.el" "mew-w3m.el" "w3m-xmas.el") "w3m-pkg.el") :host github :repo "emacs-w3m/emacs-w3m" :package "w3m" :local-repo "emacs-w3m")) "cider" ("2023-06-13 22:20:34" ("emacs" "clojure-mode" "parseedn" "queue" "spinner" "seq" "sesman") (:type git :flavor melpa :files ("*.el" (:exclude ".dir-locals.el") "cider-pkg.el") :host github :repo "clojure-emacs/cider" :package "cider" :local-repo "cider")) "clojure-mode" ("2023-06-13 22:20:34" ("emacs") (:type git :flavor melpa :files ("clojure-mode.el" "clojure-mode-pkg.el") :host github :repo "clojure-emacs/clojure-mode" :package "clojure-mode" :local-repo "clojure-mode")) "parseedn" ("2023-06-13 22:20:34" ("emacs" "parseclj" "map") (:type git :flavor melpa :host github :repo "clojure-emacs/parseedn" :package "parseedn" :local-repo "parseedn")) "parseclj" ("2023-06-13 22:20:34" ("emacs") (:type git :flavor melpa :host github :repo "clojure-emacs/parseclj" :package "parseclj" :local-repo "parseclj")) "map" ("2023-06-13 22:20:34" ("emacs") (:type git :host github :repo "emacs-straight/map" :files ("*" (:exclude ".git")) :package "map" :local-repo "map")) "queue" ("2023-07-03 19:47:21" ("cl-lib") (:type git :host github :repo "emacs-straight/queue" :files ("*" (:exclude ".git")) :package "queue" :local-repo "queue")) "spinner" ("2023-06-13 22:20:34" ("emacs") (:type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git")) :package "spinner" :local-repo "spinner")) "sesman" ("2023-06-13 22:20:34" ("emacs") (:type git :flavor melpa :host github :repo "vspinu/sesman" :package "sesman" :local-repo "sesman")) "clojure-mode-extra-font-locking" ("2023-06-13 22:20:34" ("clojure-mode") (:flavor melpa :files ("clojure-mode-extra-font-locking.el" "clojure-mode-extra-font-locking-pkg.el") :package "clojure-mode-extra-font-locking" :local-repo "clojure-mode" :type git :repo "clojure-emacs/clojure-mode" :host github)) "markdown-mode" ("2023-07-03 19:47:20" ("emacs") (:type git :flavor melpa :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "tree-sitter" ("2023-07-03 19:47:20" ("emacs" "tsc") (:type git :flavor melpa :files (:defaults (:exclude "lisp/tree-sitter-tests.el") "tree-sitter-pkg.el") :branch "release" :host github :repo "emacs-tree-sitter/elisp-tree-sitter" :package "tree-sitter" :local-repo "elisp-tree-sitter")) "tsc" ("2023-07-03 19:47:20" ("emacs") (:flavor melpa :files ("core/*.el" "core/Cargo.toml" "core/Cargo.lock" "core/src" "tsc-pkg.el") :package "tsc" :local-repo "elisp-tree-sitter" :type git :repo "emacs-tree-sitter/elisp-tree-sitter" :host github :branch "release")) "tree-sitter-langs" ("2023-07-03 19:47:20" ("emacs" "tree-sitter") (:type git :flavor melpa :files (:defaults "queries" "tree-sitter-langs-pkg.el") :branch "release" :host github :repo "emacs-tree-sitter/tree-sitter-langs" :package "tree-sitter-langs" :local-repo "tree-sitter-langs")) "aggressive-indent" ("2023-07-03 19:47:21" ("emacs") (:type git :flavor melpa :host github :repo "Malabarba/aggressive-indent-mode" :package "aggressive-indent" :local-repo "aggressive-indent-mode")) "undo-tree" ("2023-07-03 19:47:21" ("queue" "emacs") (:type git :host github :repo "emacs-straight/undo-tree" :files ("*" (:exclude ".git")) :package "undo-tree" :local-repo "undo-tree")) "which-key" ("2023-07-03 19:47:21" ("emacs") (:type git :flavor melpa :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "avy" ("2023-07-03 19:47:21" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "abo-abo/avy" :package "avy" :local-repo "avy")) "crux" ("2023-07-03 19:47:21" ("seq") (:type git :flavor melpa :host github :repo "bbatsov/crux" :package "crux" :local-repo "crux")) "expand-region" ("2023-07-03 19:47:21" nil (:type git :flavor melpa :host github :repo "magnars/expand-region.el" :package "expand-region" :local-repo "expand-region.el")) "exec-path-from-shell" ("2023-07-03 19:47:19" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "purcell/exec-path-from-shell" :package "exec-path-from-shell" :local-repo "exec-path-from-shell"))))
...
(fn &optional MESSAGE)" t nil) (autoload 'org-roam-diagnostics "org-roam-utils" "Collect and print info for `org-roam' issues." t nil) (register-definition-prefixes "org-roam-utils" '("org-roam-")) (provide 'org-roam-autoloads)) "deft" ((deft deft-autoloads) (autoload 'deft-find-file "deft" "Find FILE interactively using the minibuffer.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "vertico-buffer" '("vertico-buffer-")) (autoload 'vertico-directory-enter "vertico-directory" "Enter directory or exit completion with current candidate." t nil) (autoload 'vertico-directory-up "vertico-directory" "Delete N names before point.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "vertico-reverse" '("vertico-reverse-map")) (defvar vertico-unobtrusive-mode nil "Non-nil if Vertico-Unobtrusive mode is enabled.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "vertico-unobtrusive" '("vertico-unobtrusive--orig-count")) (provide 'vertico-autoloads)) "orderless" ((orderless orderless-autoloads) (autoload 'orderless-filter "orderless" "Split STRING into components and find entries TABLE matching all.
...
(fn STR)" nil nil) (register-definition-prefixes "orderless" '("orderless-")) (provide 'orderless-autoloads)) "embark" ((embark-autoloads embark-org embark) (defun embark--record-this-command nil "Record command which opened the minibuffer.
...
(fn &optional ARG)" t nil) (autoload 'marginalia-cycle "marginalia" "Cycle between annotators in `marginalia-annotator-registry'." t nil) (register-definition-prefixes "marginalia" '("marginalia-")) (provide 'marginalia-autoloads)) "corfu" ((corfu-autoloads corfu) (autoload 'corfu-mode "corfu" "COmpletion in Region FUnction.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "corfu" '("corfu-")) (provide 'corfu-autoloads)) "transient" ((transient transient-autoloads) (autoload 'transient-insert-suffix "transient" "Insert a SUFFIX into PREFIX before LOC.
...
(fn WORKTREE PATH)" t nil) (register-definition-prefixes "magit-worktree" '("magit-")) (provide 'magit-autoloads)) "vterm" ((vterm-autoloads vterm) (autoload 'vterm-module-compile "vterm" "Compile vterm-module." t nil) (autoload 'vterm--bookmark-handler "vterm" "Handler to restore a vterm bookmark BMK.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "vterm" '("vterm-")) (provide 'vterm-autoloads)) "osx-lib" ((osx-lib-autoloads osx-lib) (autoload 'osx-lib-run-osascript "osx-lib" "Run an SCRIPT-CONTENT as AppleScript/osascipt.

(fn SCRIPT-CONTENT)" t nil) (autoload 'osx-lib-osx-version "osx-lib" "Get OS version." t nil) (autoload 'osx-lib-run-js "osx-lib" "Run an SCRIPT-CONTENT as JavaScript.

(fn SCRIPT-CONTENT)" t nil) (autoload 'osx-lib-do-beep "osx-lib" "Play beep sound." nil nil) (autoload 'osx-lib-notify2 "osx-lib" "Create a notification with title as TITLE and message as MESSAGE.

(fn TITLE MESSAGE)" nil nil) (autoload 'osx-lib-notify3 "osx-lib" "Create a notification with title as TITLE, subtitle as SUBTITLE and message as MESSAGE.

(fn TITLE SUBTITLE MESSAGE)" nil nil) (autoload 'osx-lib-copy-to-clipboard "osx-lib" "Copy the given TEXT to clipboard.

(fn &optional TEXT)" t nil) (autoload 'osx-lib-reveal-in-finder-as "osx-lib" "Reveal the supplied file FILE in Finder.
This function runs the actual AppleScript.

(fn FILE)" nil nil) (autoload 'osx-lib-reveal-in-finder "osx-lib" "Reveal the file associated with the current buffer in the OS X Finder.
In a dired buffer, it will open the current file." t nil) (autoload 'osx-lib-vpn-connect "osx-lib" "Connect to vpn using given VPN-NAME and PASSWORD.

(fn VPN-NAME PASSWORD)" t nil) (autoload 'osx-lib-vpn-disconnect "osx-lib" "Disconnect from VPN-NAME vpn.

(fn VPN-NAME)" t nil) (autoload 'osx-lib-say "osx-lib" "Speak the MESSAGE.

(fn MESSAGE)" t nil) (autoload 'osx-lib-open-url-at-point "osx-lib" "Open URL at point using default browser.

(fn URL)" t nil) (autoload 'osx-lib-set-volume "osx-lib" "Set sound output volume to VOL(0-100).

(fn VOL)" t nil) (autoload 'osx-lib-get-volume "osx-lib" "Get sound output volume (0-100)." nil nil) (autoload 'osx-lib-start-terminal "osx-lib" "Start terminal in DIR.

(fn &optional (DIR default-directory) CMD-WITH-QUOTED-ARGS)" t nil) (autoload 'osx-lib-network-quality "osx-lib" "Test the network's quality using the built-in NQ tool." t nil) (register-definition-prefixes "osx-lib" '("osx-lib-" "with-min-osx-ver")) (provide 'osx-lib-autoloads)) "projectile" ((projectile-autoloads projectile) (autoload 'projectile-version "projectile" "Get the Projectile version as string.
...
(fn BOOKMARK)" nil nil) (register-definition-prefixes "bookmark-w3m" '("bookmark-w3m-")) (autoload 'mime-w3m-preview-text/html "mime-w3m" "

(fn ENTITY SITUATION)" nil nil) (register-definition-prefixes "mime-w3m" '("mime-w3m-")) (autoload 'w3m-retrieve "w3m" "Retrieve web contents pointed to by URL.
...
(fn &optional URL CHARSET)" t nil) (register-definition-prefixes "w3m" '("emacs-w3m-version" "w3m-")) (autoload 'w3m-about-antenna "w3m-antenna" "
...
(fn &optional NO-CACHE)" t nil) (register-definition-prefixes "w3m-antenna" '("w3m-antenna-")) (autoload 'w3m-bookmark-add-this-url "w3m-bookmark" "Add link under cursor to bookmark." t nil) (autoload 'w3m-bookmark-add-current-url "w3m-bookmark" "Add a url of the current page to the bookmark.
...
(fn &rest ARGS)" nil nil) (autoload 'w3m-setup-bookmark-menu "w3m-bookmark" "Setup w3m bookmark items in menubar." nil nil) (register-definition-prefixes "w3m-bookmark" '("w3m-bookmark-")) (autoload 'report-emacs-w3m-bug "w3m-bug" "Report a bug in emacs-w3m.
Prompts for bug subject.  Leaves you in a mail buffer.

(fn TOPIC &optional BUFFER)" t nil) (register-definition-prefixes "w3m-bug" '("report-emacs-w3m-bug-")) (autoload 'w3m-cookie-shutdown "w3m-cookie" "Save cookies, and reset cookies' data.
...
(fn URL &optional NO-DECODE NO-CACHE POST-DATA &rest ARGS)" nil nil) (register-definition-prefixes "w3m-cookie" '("w3m-")) (autoload 'w3m-about-dtree "w3m-dtree" "
...
(fn ALLFILES PATH)" t nil) (register-definition-prefixes "w3m-dtree" '("w3m-dtree-")) (register-definition-prefixes "w3m-ems" '("w3m-")) (register-definition-prefixes "w3m-favicon" '("w3m-")) (defvar w3m-fb-mode nil "Non-nil if W3m-Fb mode is enabled.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "w3m-fb" '("w3m-fb-")) (autoload 'w3m-filter "w3m-filter" "Apply filtering rule of URL against a content in this buffer.

(fn URL)" nil nil) (autoload 'w3m-toggle-filtering "w3m-filter" "Toggle whether to modify html source by the filters before rendering.
With prefix arg, prompt for a single filter to toggle (a function
toggled last will first appear) with completion.

(fn ARG)" t nil) (register-definition-prefixes "w3m-filter" '("w3m-filter-")) (autoload 'w3m-fontify-forms "w3m-form" "Process half-dumped data and fontify forms in this buffer." nil nil) (register-definition-prefixes "w3m-form" '("w3m-fo")) (register-definition-prefixes "w3m-hist" '("w3m-history")) (register-definition-prefixes "w3m-image" '("w3m-")) (autoload 'w3m-lnum-mode "w3m-lnum" "Minor mode to extend point commands by using Conkeror style number selection.
...
(fn ARG)" t nil) (autoload 'w3m-lnum-universal "w3m-lnum" "Turn on link numbers, ask for one and offer actions over it.
...
the action line or left clicking." t nil) (autoload 'w3m-lnum-toggle-inline-image "w3m-lnum" "If image at point, toggle it.
...
If no link under point, activate numbering and ask for one." t nil) (register-definition-prefixes "w3m-lnum" '("w3m-")) (register-definition-prefixes "w3m-mail" '("w3m-mail")) (autoload 'w3m-about-namazu "w3m-namazu" "

(fn URL &optional NO-DECODE NO-CACHE &rest ARGS)" nil nil) (autoload 'w3m-namazu "w3m-namazu" "Search indexed files with Namazu.

(fn INDEX QUERY &optional RELOAD)" t nil) (register-definition-prefixes "w3m-namazu" '("w3m-namazu-")) (autoload 'w3m-about-perldoc "w3m-perldoc" "

(fn URL &optional NO-DECODE NO-CACHE &rest ARGS)" nil nil) (autoload 'w3m-perldoc "w3m-perldoc" "View Perl documents.

(fn DOCNAME)" t nil) (register-definition-prefixes "w3m-perldoc" '("w3m-perldoc-")) (register-definition-prefixes "w3m-proc" '("w3m-process-")) (register-definition-prefixes "w3m-rss" '("w3m-rss-")) (register-definition-prefixes "w3m-save" '("w3m-save-buffer")) (autoload 'w3m-search "w3m-search" "Search QUERY using SEARCH-ENGINE.
...
(fn URI ENGINE)" nil nil) (register-definition-prefixes "w3m-search" '("w3m-search-")) (autoload 'w3m-session-save "w3m-session" "Save the current session (all currently open emacs-w3m buffers).
...
(fn &optional N TOGGLE NOMSG)" t nil) (autoload 'w3m-setup-session-menu "w3m-session" "Setup w3m session items in menubar." nil nil) (autoload 'w3m-session-last-autosave-session "w3m-session" nil nil nil) (autoload 'w3m-session-last-crashed-session "w3m-session" nil nil nil) (register-definition-prefixes "w3m-session" '("w3m-")) (autoload 'w3m-replace-symbol "w3m-symbol" nil nil nil) (register-definition-prefixes "w3m-symbol" '("w3m-")) (register-definition-prefixes "w3m-tabmenu" '("w3m-")) (register-definition-prefixes "w3m-util" '("w3m-")) (autoload 'w3m-weather "w3m-weather" "Display weather report.

(fn AREA)" t nil) (autoload 'w3m-about-weather "w3m-weather" "

(fn URL NO-DECODE NO-CACHE POST-DATA REFERER HANDLER)" nil nil) (register-definition-prefixes "w3m-weather" '("w3m-weather-")) (provide 'w3m-autoloads)) "clojure-mode" ((clojure-mode-autoloads clojure-mode) (autoload 'clojure-mode "clojure-mode" "Major mode for editing Clojure code.
...
(fn &optional TYPE-OR-OBJECT FPS DELAY)" nil nil) (register-definition-prefixes "spinner" '("spinner-")) (provide 'spinner-autoloads)) "sesman" ((sesman sesman-browser sesman-autoloads) (autoload 'sesman-start "sesman" "Start a Sesman session." t nil) (autoload 'sesman-restart "sesman" "Restart sesman session.
...
(fn &optional NS SYMBOL)" t nil) (register-definition-prefixes "cider-xref" '("cider-")) (register-definition-prefixes "nrepl-client" '("cider-" "emacs-bug-46284/when-27.1-windows-nt" "nrepl-")) (register-definition-prefixes "nrepl-dict" '("nrepl-")) (provide 'cider-autoloads)) "clojure-mode-extra-font-locking" ((clojure-mode-extra-font-locking-autoloads clojure-mode-extra-font-locking) (register-definition-prefixes "clojure-mode-extra-font-locking" '("clojure-built-in-")) (provide 'clojure-mode-extra-font-locking-autoloads)) "markdown-mode" ((markdown-mode markdown-mode-autoloads) (autoload 'markdown-mode "markdown-mode" "Major mode for editing Markdown files.
...
(fn &optional ARG)" t nil) (defalias 'aggressive-indent-global-mode #'global-aggressive-indent-mode) (register-definition-prefixes "aggressive-indent" '("aggressive-indent-")) (provide 'aggressive-indent-autoloads)) "undo-tree" ((undo-tree undo-tree-autoloads) (autoload 'undo-tree-mode "undo-tree" "Toggle undo-tree mode.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "undo-tree" '("*undo-tree-id-counter*" "buffer-undo-tree" "turn-on-undo-tree-mode" "undo-")) (provide 'undo-tree-autoloads)) "which-key" ((which-key which-key-autoloads) (defvar which-key-mode nil "Non-nil if Which-Key mode is enabled.
...
KEYMAP is selected interactively by mode in
`minor-mode-map-alist'." t nil) (register-definition-prefixes "which-key" '("evil-state" "which-key-")) (provide 'which-key-autoloads)) "avy" ((avy-autoloads avy) (autoload 'avy-process "avy" "Select one of CANDIDATES using `avy-read'.
...
(fn &optional ARG)" t nil) (autoload 'avy-transpose-lines-in-region "avy" "Transpose lines in the active region." t nil) (register-definition-prefixes "avy" '("avy-")) (provide 'avy-autoloads)) "crux" ((crux crux-autoloads) (autoload 'crux-open-with "crux" "Open visited file in default external program.
...
values used in the user's shell." t nil) (register-definition-prefixes "exec-path-from-shell" '("exec-path-from-shell-")) (provide 'exec-path-from-shell-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 15 "melpa" nil "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "use-package" nil "bind-key" nil "org" (org :type git :repo "https://git.savannah.gnu.org/git/emacs/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*"))) "org-roam" nil "dash" nil "emacsql" nil "magit-section" nil "compat" nil "seq" nil "deft" nil "vertico" nil "orderless" nil "embark" nil "embark-consult" nil "consult" nil "marginalia" nil "corfu" nil "magit" nil "git-commit" nil "transient" nil "with-editor" nil "vterm" nil "osx-lib" nil "projectile" nil "racket-mode" nil "sly" nil "auto-complete" nil "popup" nil "cl-lib" nil "ac-sly" nil "smartparens" nil "rainbow-delimiters" nil "w3m" nil "cider" nil "clojure-mode" nil "parseedn" nil "parseclj" nil "map" nil "queue" nil "spinner" nil "sesman" nil "clojure-mode-extra-font-locking" nil "markdown-mode" nil "tree-sitter" nil "tsc" nil "tree-sitter-langs" nil "aggressive-indent" nil "undo-tree" nil "which-key" nil "avy" nil "crux" nil "expand-region" nil "exec-path-from-shell" nil)) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "use-package" (use-package :type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package") "bind-key" (bind-key :type git :flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :host github :repo "jwiegley/use-package") "org-roam" (org-roam :type git :flavor melpa :files (:defaults "extensions/*" "org-roam-pkg.el") :host github :repo "org-roam/org-roam") "dash" (dash :type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "emacsql" (emacsql :type git :flavor melpa :files (:defaults "sqlite" "emacsql-pkg.el") :host github :repo "magit/emacsql") "magit-section" (magit-section :type git :flavor melpa :files ("lisp/magit-section.el" "lisp/magit-section-pkg.el" "docs/magit-section.texi" "Documentation/magit-section.texi" "magit-section-pkg.el") :host github :repo "magit/magit") "compat" nil "seq" nil "deft" (deft :type git :flavor melpa :host github :repo "jrblevin/deft") "vertico" nil "orderless" (orderless :type git :flavor melpa :host github :repo "oantolin/orderless") "embark" (embark :type git :flavor melpa :files ("embark.el" "embark-org.el" "embark.texi" "embark-pkg.el") :host github :repo "oantolin/embark") "embark-consult" (embark-consult :type git :flavor melpa :files ("embark-consult.el" "embark-consult-pkg.el") :host github :repo "oantolin/embark") "consult" (consult :type git :flavor melpa :host github :repo "minad/consult") "marginalia" (marginalia :type git :flavor melpa :host github :repo "minad/marginalia") "corfu" nil "magit" (magit :type git :flavor melpa :files ("lisp/magit*.el" "lisp/git-rebase.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" "Documentation/magit.texi" "Documentation/AUTHORS.md" (:exclude "lisp/magit-libgit.el" "lisp/magit-libgit-pkg.el" "lisp/magit-section.el" "lisp/magit-section-pkg.el") "magit-pkg.el") :host github :repo "magit/magit") "git-commit" (git-commit :type git :flavor melpa :files ("lisp/git-commit.el" "lisp/git-commit-pkg.el" "git-commit-pkg.el") :host github :repo "magit/magit") "transient" (transient :type git :flavor melpa :host github :repo "magit/transient") "with-editor" (with-editor :type git :flavor melpa :host github :repo "magit/with-editor") "vterm" (vterm :type git :flavor melpa :files ("CMakeLists.txt" "elisp.c" "elisp.h" "emacs-module.h" "etc" "utf8.c" "utf8.h" "vterm.el" "vterm-module.c" "vterm-module.h" "vterm-pkg.el") :host github :repo "akermu/emacs-libvterm") "osx-lib" (osx-lib :type git :flavor melpa :host github :repo "raghavgautam/osx-lib") "projectile" (projectile :type git :flavor melpa :host github :repo "bbatsov/projectile") "racket-mode" (racket-mode :type git :flavor melpa :files (:defaults "*.rkt" ("racket" "racket/*") (:exclude "racket/example/*" "racket/test/*") "racket-mode-pkg.el") :host github :repo "greghendershott/racket-mode") "sly" (sly :type git :flavor melpa :files (:defaults "lib" "slynk" "contrib" "doc/images" (:exclude "sly-autoloads.el") "sly-pkg.el") :host github :repo "joaotavora/sly") "auto-complete" (auto-complete :type git :flavor melpa :files ("*.el" "dict" "auto-complete-pkg.el") :host github :repo "auto-complete/auto-complete") "popup" (popup :type git :flavor melpa :host github :repo "auto-complete/popup-el") "cl-lib" nil "ac-sly" (ac-sly :type git :flavor melpa :host github :repo "qoocku/ac-sly") "smartparens" (smartparens :type git :flavor melpa :host github :repo "Fuco1/smartparens") "rainbow-delimiters" (rainbow-delimiters :type git :flavor melpa :host github :repo "Fanael/rainbow-delimiters") "w3m" (w3m :type git :flavor melpa :files (:defaults "icons" (:exclude "octet.el" "mew-w3m.el" "w3m-xmas.el") "w3m-pkg.el") :host github :repo "emacs-w3m/emacs-w3m") "cider" (cider :type git :flavor melpa :files ("*.el" (:exclude ".dir-locals.el") "cider-pkg.el") :host github :repo "clojure-emacs/cider") "clojure-mode" (clojure-mode :type git :flavor melpa :files ("clojure-mode.el" "clojure-mode-pkg.el") :host github :repo "clojure-emacs/clojure-mode") "parseedn" (parseedn :type git :flavor melpa :host github :repo "clojure-emacs/parseedn") "parseclj" (parseclj :type git :flavor melpa :host github :repo "clojure-emacs/parseclj") "map" nil "queue" nil "spinner" nil "sesman" (sesman :type git :flavor melpa :host github :repo "vspinu/sesman") "clojure-mode-extra-font-locking" (clojure-mode-extra-font-locking :type git :flavor melpa :files ("clojure-mode-extra-font-locking.el" "clojure-mode-extra-font-locking-pkg.el") :host github :repo "clojure-emacs/clojure-mode") "markdown-mode" (markdown-mode :type git :flavor melpa :host github :repo "jrblevin/markdown-mode") "tree-sitter" (tree-sitter :type git :flavor melpa :files (:defaults (:exclude "lisp/tree-sitter-tests.el") "tree-sitter-pkg.el") :branch "release" :host github :repo "emacs-tree-sitter/elisp-tree-sitter") "tsc" (tsc :type git :flavor melpa :files ("core/*.el" "core/Cargo.toml" "core/Cargo.lock" "core/src" "tsc-pkg.el") :branch "release" :host github :repo "emacs-tree-sitter/elisp-tree-sitter") "tree-sitter-langs" (tree-sitter-langs :type git :flavor melpa :files (:defaults "queries" "tree-sitter-langs-pkg.el") :branch "release" :host github :repo "emacs-tree-sitter/tree-sitter-langs") "aggressive-indent" (aggressive-indent :type git :flavor melpa :host github :repo "Malabarba/aggressive-indent-mode") "undo-tree" nil "which-key" (which-key :type git :flavor melpa :host github :repo "justbur/emacs-which-key") "avy" (avy :type git :flavor melpa :host github :repo "abo-abo/avy") "crux" (crux :type git :flavor melpa :host github :repo "bbatsov/crux") "expand-region" (expand-region :type git :flavor melpa :host github :repo "magnars/expand-region.el") "exec-path-from-shell" (exec-path-from-shell :type git :flavor melpa :host github :repo "purcell/exec-path-from-shell"))) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "nongnu-elpa" nil "emacsmirror-mirror" nil "straight" nil "compat" (compat :type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git"))) "seq" nil "vertico" (vertico :type git :host github :repo "emacs-straight/vertico" :files ("*" (:exclude ".git"))) "corfu" (corfu :type git :host github :repo "emacs-straight/corfu" :files ("*" (:exclude ".git"))) "cl-lib" nil "map" (map :type git :host github :repo "emacs-straight/map" :files ("*" (:exclude ".git"))) "queue" (queue :type git :host github :repo "emacs-straight/queue" :files ("*" (:exclude ".git"))) "spinner" (spinner :type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git"))) "undo-tree" (undo-tree :type git :host github :repo "emacs-straight/undo-tree" :files ("*" (:exclude ".git"))))) nongnu-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 4 "emacsmirror-mirror" nil "straight" nil "seq" nil "cl-lib" nil)) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "emacsmirror-mirror" nil "straight" nil "seq" nil "cl-lib" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "seq" nil "cl-lib" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "nongnu-elpa" "el-get" "emacsmirror-mirror" "straight" "emacs" "use-package" "bind-key" "org" "org-roam" "dash" "emacsql" "magit-section" "compat" "seq" "deft" "vertico" "orderless" "embark" "embark-consult" "consult" "marginalia" "corfu" "magit" "git-commit" "transient" "with-editor" "vterm" "exec-path-from-shell" "cl-lib" "osx-lib" "projectile" "racket-mode" "sly" "auto-complete" "popup" "ac-sly" "smartparens" "rainbow-delimiters" "w3m" "markdown-mode" "tree-sitter" "tsc" "tree-sitter-langs" "aggressive-indent" "undo-tree" "queue" "which-key" "avy" "crux" "expand-region")
