...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2024-05-01 08:16:04" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "develop" :package "straight" :local-repo "straight.el")) "org-elpa" ("2024-05-01 08:16:06" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2024-05-01 08:16:06" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2024-05-01 08:16:04" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2024-05-01 08:16:04" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2024-05-01 08:16:04" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2024-05-01 08:16:04" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "use-package" ("2024-05-01 08:16:04" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2024-05-01 08:16:04" ("emacs") (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "org" ("2024-05-01 08:16:04" ("emacs") (:type git :repo "https://git.savannah.gnu.org/git/emacs/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*")) :package "org")) "org-roam" ("2024-05-01 08:16:04" ("emacs" "dash" "org" "emacsql" "magit-section") (:type git :flavor melpa :files (:defaults "extensions/*" "org-roam-pkg.el") :host github :repo "org-roam/org-roam" :package "org-roam" :local-repo "org-roam")) "dash" ("2024-05-01 08:16:04" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "emacsql" ("2024-05-01 08:16:04" ("emacs") (:type git :flavor melpa :files (:defaults "sqlite" "emacsql-pkg.el") :host github :repo "magit/emacsql" :package "emacsql" :local-repo "emacsql")) "magit-section" ("2024-05-01 08:16:04" ("emacs" "compat" "dash") (:type git :flavor melpa :files ("lisp/magit-section.el" "lisp/magit-section-pkg.el" "docs/magit-section.texi" "Documentation/magit-section.texi" "magit-section-pkg.el") :host github :repo "magit/magit" :package "magit-section" :local-repo "magit")) "compat" ("2024-05-01 08:16:04" ("emacs" "seq") (:type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git")) :package "compat" :local-repo "compat")) "seq" ("2024-05-01 08:16:04" nil (:type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git")) :package "seq" :local-repo "seq")) "deft" ("2024-05-01 08:16:04" nil (:type git :flavor melpa :host github :repo "jrblevin/deft" :package "deft" :local-repo "deft")) "vertico" ("2024-05-01 08:16:05" ("emacs" "compat") (:files (:defaults "extensions/*") :flavor melpa :repo "minad/vertico" :host github :package "vertico" :type git :local-repo "vertico")) "orderless" ("2024-05-01 08:16:05" ("emacs") (:type git :flavor melpa :host github :repo "oantolin/orderless" :package "orderless" :local-repo "orderless")) "embark" ("2024-05-01 08:16:05" ("emacs" "compat") (:type git :flavor melpa :files ("embark.el" "embark-org.el" "embark.texi" "embark-pkg.el") :host github :repo "oantolin/embark" :package "embark" :local-repo "embark")) "embark-consult" ("2024-05-01 08:16:05" ("emacs" "compat" "embark" "consult") (:flavor melpa :files ("embark-consult.el" "embark-consult-pkg.el") :package "embark-consult" :local-repo "embark" :type git :repo "oantolin/embark" :host github)) "consult" ("2024-05-01 08:16:05" ("emacs" "compat") (:type git :flavor melpa :host github :repo "minad/consult" :package "consult" :local-repo "consult")) "marginalia" ("2024-05-01 08:16:05" ("emacs" "compat") (:type git :flavor melpa :host github :repo "minad/marginalia" :package "marginalia" :local-repo "marginalia")) "corfu" ("2024-05-01 08:16:05" ("emacs" "compat") (:type git :flavor melpa :files (:defaults "extensions/corfu-*.el" "corfu-pkg.el") :host github :repo "minad/corfu" :package "corfu" :local-repo "corfu")) "magit" ("2024-05-01 08:16:05" ("emacs" "compat" "dash" "git-commit" "magit-section" "seq" "transient" "with-editor") (:flavor melpa :files ("lisp/magit*.el" "lisp/git-rebase.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" "Documentation/magit.texi" "Documentation/AUTHORS.md" (:exclude "lisp/magit-libgit.el" "lisp/magit-libgit-pkg.el" "lisp/magit-section.el" "lisp/magit-section-pkg.el") "magit-pkg.el") :package "magit" :local-repo "magit" :type git :repo "magit/magit" :host github)) "git-commit" ("2024-05-01 08:16:05" ("emacs" "compat" "transient" "with-editor") (:flavor melpa :files ("lisp/git-commit.el" "lisp/git-commit-pkg.el" "git-commit-pkg.el") :package "git-commit" :local-repo "magit" :type git :repo "magit/magit" :host github)) "transient" ("2024-05-01 08:16:05" ("emacs" "compat" "seq") (:type git :flavor melpa :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2024-05-01 08:16:05" ("emacs" "compat") (:type git :flavor melpa :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "exec-path-from-shell" ("2024-05-01 08:16:05" ("emacs") (:type git :flavor melpa :host github :repo "purcell/exec-path-from-shell" :package "exec-path-from-shell" :local-repo "exec-path-from-shell")) "osx-lib" ("2024-05-01 08:16:05" ("emacs") (:type git :flavor melpa :host github :repo "raghavgautam/osx-lib" :package "osx-lib" :local-repo "osx-lib")) "projectile" ("2024-05-01 08:16:05" ("emacs") (:type git :flavor melpa :host github :repo "bbatsov/projectile" :package "projectile" :local-repo "projectile")) "treemacs" ("2024-05-01 08:16:06" ("emacs" "cl-lib" "dash" "s" "ace-window" "pfuture" "hydra" "ht" "cfrs") (:type git :flavor melpa :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs" :package "treemacs" :local-repo "treemacs")) "s" ("2024-05-01 08:16:06" nil (:type git :flavor melpa :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "ace-window" ("2024-05-01 08:16:06" ("avy") (:type git :flavor melpa :host github :repo "abo-abo/ace-window" :package "ace-window" :local-repo "ace-window")) "avy" ("2024-05-01 08:16:06" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "abo-abo/avy" :package "avy" :local-repo "avy")) "pfuture" ("2024-05-01 08:16:06" ("emacs") (:type git :flavor melpa :host github :repo "Alexander-Miller/pfuture" :package "pfuture" :local-repo "pfuture")) "hydra" ("2024-05-01 08:16:06" ("cl-lib" "lv") (:type git :flavor melpa :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra" :package "hydra" :local-repo "hydra")) "lv" ("2024-05-01 08:16:06" nil (:flavor melpa :files ("lv.el" "lv-pkg.el") :package "lv" :local-repo "hydra" :type git :repo "abo-abo/hydra" :host github)) "ht" ("2024-05-01 08:16:06" ("dash") (:type git :flavor melpa :host github :repo "Wilfred/ht.el" :package "ht" :local-repo "ht.el")) "cfrs" ("2024-05-01 08:16:06" ("emacs" "dash" "s" "posframe") (:type git :flavor melpa :host github :repo "Alexander-Miller/cfrs" :package "cfrs" :local-repo "cfrs")) "posframe" ("2024-05-01 08:16:05" ("emacs") (:type git :flavor melpa :host github :repo "tumashu/posframe" :package "posframe" :local-repo "posframe")) "treemacs-projectile" ("2024-05-01 08:16:06" ("emacs" "projectile" "treemacs") (:flavor melpa :files ("src/extra/treemacs-projectile.el" "treemacs-projectile-pkg.el") :package "treemacs-projectile" :local-repo "treemacs" :type git :repo "Alexander-Miller/treemacs" :host github)) "sly" ("2024-05-01 08:16:06" ("emacs") (:type git :flavor melpa :files (:defaults "lib" "slynk" "contrib" "doc/images" (:exclude "sly-autoloads.el") "sly-pkg.el") :host github :repo "joaotavora/sly" :package "sly" :local-repo "sly")) "auto-complete" ("2024-05-01 08:16:06" ("popup" "cl-lib") (:type git :flavor melpa :files ("*.el" "dict" "auto-complete-pkg.el") :host github :repo "auto-complete/auto-complete" :package "auto-complete" :local-repo "auto-complete")) "popup" ("2024-05-01 08:16:06" ("emacs") (:type git :flavor melpa :host github :repo "auto-complete/popup-el" :package "popup" :local-repo "popup-el")) "ac-sly" ("2024-05-01 08:16:06" ("sly" "auto-complete" "cl-lib") (:type git :flavor melpa :host github :repo "qoocku/ac-sly" :package "ac-sly" :local-repo "ac-sly")) "lispy" ("2024-05-01 08:16:06" ("emacs" "ace-window" "iedit" "swiper" "hydra" "zoutline") (:type git :flavor melpa :files (:defaults "lispy-clojure.clj" "lispy-clojure.cljs" "lispy-python.py" "lispy-pkg.el") :host github :repo "abo-abo/lispy" :package "lispy" :local-repo "lispy")) "iedit" ("2024-05-01 08:16:06" nil (:type git :flavor melpa :host github :repo "victorhge/iedit" :package "iedit" :local-repo "iedit")) "swiper" ("2024-05-01 08:16:06" ("emacs" "ivy") (:type git :flavor melpa :files ("swiper.el" "swiper-pkg.el") :host github :repo "abo-abo/swiper" :package "swiper" :local-repo "swiper")) "ivy" ("2024-05-01 08:16:06" ("emacs") (:flavor melpa :files (:defaults "doc/ivy-help.org" (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "ivy-pkg.el") :package "ivy" :local-repo "swiper" :type git :repo "abo-abo/swiper" :host github)) "zoutline" ("2024-05-01 08:16:06" nil (:type git :flavor melpa :host github :repo "abo-abo/zoutline" :package "zoutline" :local-repo "zoutline")) "rainbow-delimiters" ("2024-05-01 08:16:06" nil (:type git :flavor melpa :host github :repo "Fanael/rainbow-delimiters" :package "rainbow-delimiters" :local-repo "rainbow-delimiters")) "emacs-w3m" ("2024-05-01 08:16:06" nil (:type git :host github :repo "emacs-w3m/emacs-w3m" :pre-build (("autoconf") ("./configure" "--with-emacs=/Applications/Emacs.app/Contents/MacOS/Emacs") ("make")) :files (:defaults) :package "emacs-w3m" :local-repo "emacs-w3m")) "markdown-mode" ("2024-05-01 08:16:06" ("emacs") (:type git :flavor melpa :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "aggressive-indent" ("2024-05-01 08:16:06" ("emacs") (:type git :flavor melpa :host github :repo "Malabarba/aggressive-indent-mode" :package "aggressive-indent" :local-repo "aggressive-indent-mode")) "undo-tree" ("2024-05-01 08:16:06" ("queue" "emacs") (:type git :host github :repo "emacs-straight/undo-tree" :files ("*" (:exclude ".git")) :package "undo-tree" :local-repo "undo-tree")) "queue" ("2024-05-01 08:16:06" ("cl-lib") (:type git :host github :repo "emacs-straight/queue" :files ("*" (:exclude ".git")) :package "queue" :local-repo "queue")) "which-key" ("2024-05-01 08:16:06" ("emacs") (:type git :flavor melpa :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "crux" ("2024-05-01 08:16:06" ("emacs") (:type git :flavor melpa :host github :repo "bbatsov/crux" :package "crux" :local-repo "crux")) "expand-region" ("2024-05-01 08:16:06" ("emacs") (:type git :flavor melpa :host github :repo "magnars/expand-region.el" :package "expand-region" :local-repo "expand-region.el")) "org-ai" ("2024-05-01 08:12:25" ("emacs" "websocket") (:type git :host github :repo "rksm/org-ai" :local-repo "org-ai" :files ("*.el" "README.md" "snippets") :flavor melpa :package "org-ai")) "websocket" ("2024-05-01 08:12:25" ("cl-lib") (:type git :flavor melpa :host github :repo "ahyatt/emacs-websocket" :package "websocket" :local-repo "emacs-websocket")) "vertico-posframe" ("2024-05-01 08:16:05" ("emacs" "posframe" "vertico") (:type git :host github :repo "emacs-straight/vertico-posframe" :files ("*" (:exclude ".git")) :package "vertico-posframe" :local-repo "vertico-posframe")) "golden-ratio" ("2024-05-01 08:16:07" nil (:type git :flavor melpa :host github :repo "roman/golden-ratio.el" :package "golden-ratio" :local-repo "golden-ratio.el"))))
...
(fn WORKTREE PATH)" t) (register-definition-prefixes "magit-worktree" '("magit-")) (provide 'magit-autoloads)) "exec-path-from-shell" ((exec-path-from-shell exec-path-from-shell-autoloads) (autoload 'exec-path-from-shell-copy-envs "exec-path-from-shell" "Set the environment variables with NAMES from the user's shell.
...
(fn &optional ARG)" t) (define-obsolete-function-alias 'projectile-global-mode 'projectile-mode "1.0") (register-definition-prefixes "projectile" '("??" "compilation-find-file-projectile-find-compilation-buffer" "def-projectile-commander-method" "delete-file-projectile-remove-from-cache" "project" "savehist-additional-variables")) (provide 'projectile-autoloads)) "s" ((s s-autoloads) (register-definition-prefixes "s" '("s-")) (provide 's-autoloads)) "avy" ((avy-autoloads avy) (autoload 'avy-process "avy" "Select one of CANDIDATES using `avy-read'.
...
(fn &optional FUZZY)" t) (register-definition-prefixes "ac-sly" '("ac-s")) (provide 'ac-sly-autoloads)) "iedit" ((iedit-lib iedit iedit-rect iedit-autoloads) (autoload 'iedit-mode "iedit" "Toggle Iedit mode.
...
See `lispy-occur-backend' for the selection back end." t) (register-definition-prefixes "lispy-occur" '("lispy-")) (register-definition-prefixes "lispy-tags" '("lispy-" "no-semantic-support")) (provide 'lispy-autoloads)) "rainbow-delimiters" ((rainbow-delimiters rainbow-delimiters-autoloads) (autoload 'rainbow-delimiters-mode "rainbow-delimiters" "Highlight nested parentheses, brackets, and braces according to their depth.
...
(fn URL NO-DECODE NO-CACHE POST-DATA REFERER HANDLER)") (register-definition-prefixes "w3m-weather" '("w3m-weather-")) (provide 'emacs-w3m-autoloads)) "markdown-mode" ((markdown-mode markdown-mode-autoloads) (autoload 'markdown-mode "markdown-mode" "Major mode for editing Markdown files.
...
KEYMAP is selected interactively by mode in
`minor-mode-map-alist'." t) (register-definition-prefixes "which-key" '("evil-state" "which-key-")) (provide 'which-key-autoloads)) "crux" ((crux crux-autoloads) (autoload 'crux-open-with "crux" "Open visited file in default external program.
...
(fn &optional ARG)" t) (register-definition-prefixes "org-ai" '("org-ai-")) (register-definition-prefixes "org-ai-block" '("org-ai-")) (autoload 'org-ai-on-project "org-ai-on-project" "Start org-ai-on-project inside BASE-DIR.
...
(fn &optional BASE-DIR)" t) (register-definition-prefixes "org-ai-on-project" '("org-ai-on-")) (register-definition-prefixes "org-ai-oobabooga" '("org-ai-")) (register-definition-prefixes "org-ai-openai" '("org-ai-" "strip-api-url")) (register-definition-prefixes "org-ai-openai-image" '("org-ai-")) (register-definition-prefixes "org-ai-sd" '("org-ai-")) (register-definition-prefixes "org-ai-talk" '("org-ai-talk-")) (register-definition-prefixes "org-ai-useful" '("org-ai-")) (provide 'org-ai-autoloads)) "vertico-posframe" ((vertico-posframe vertico-posframe-autoloads) (defvar vertico-posframe-mode nil "Non-nil if Vertico-Posframe mode is enabled.
...
(fn &optional ARG)" t) (autoload 'vertico-posframe-cleanup "vertico-posframe" "Remove frames and buffers used for vertico-posframe." t) (register-definition-prefixes "vertico-posframe" '("vertico-posframe-")) (provide 'vertico-posframe-autoloads)) "golden-ratio" ((golden-ratio golden-ratio-autoloads) (autoload 'golden-ratio "golden-ratio" "Resizes current window to the golden-ratio's size specs.
...
(fn &optional ARG)" t) (register-definition-prefixes "golden-ratio" '("golden-ratio-")) (provide 'golden-ratio-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 15 "melpa" nil "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "use-package" nil "bind-key" nil "org" (org :type git :repo "https://git.savannah.gnu.org/git/emacs/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*"))) "org-roam" nil "dash" nil "emacsql" nil "magit-section" nil "compat" nil "seq" nil "deft" nil "vertico" nil "orderless" nil "embark" nil "embark-consult" nil "consult" nil "marginalia" nil "corfu" nil "magit" nil "git-commit" nil "transient" nil "with-editor" nil "exec-path-from-shell" nil "osx-lib" nil "projectile" nil "treemacs" nil "cl-lib" nil "s" nil "ace-window" nil "avy" nil "pfuture" nil "hydra" nil "lv" nil "ht" nil "cfrs" nil "posframe" nil "treemacs-projectile" nil "sly" nil "auto-complete" nil "popup" nil "ac-sly" nil "lispy" nil "iedit" nil "swiper" nil "ivy" nil "zoutline" nil "rainbow-delimiters" nil "emacs-w3m" nil "markdown-mode" nil "aggressive-indent" nil "undo-tree" nil "queue" nil "which-key" nil "crux" nil "expand-region" nil "org-ai" nil "websocket" nil "vertico-posframe" nil "golden-ratio" nil)) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "use-package" (use-package :type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package") "bind-key" (bind-key :type git :flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :host github :repo "jwiegley/use-package") "org-roam" (org-roam :type git :flavor melpa :files (:defaults "extensions/*" "org-roam-pkg.el") :host github :repo "org-roam/org-roam") "dash" (dash :type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "emacsql" (emacsql :type git :flavor melpa :files (:defaults "sqlite" "emacsql-pkg.el") :host github :repo "magit/emacsql") "magit-section" (magit-section :type git :flavor melpa :files ("lisp/magit-section.el" "lisp/magit-section-pkg.el" "docs/magit-section.texi" "Documentation/magit-section.texi" "magit-section-pkg.el") :host github :repo "magit/magit") "compat" nil "seq" nil "deft" (deft :type git :flavor melpa :host github :repo "jrblevin/deft") "vertico" (vertico :type git :flavor melpa :files (:defaults "extensions/vertico-*.el" "vertico-pkg.el") :host github :repo "minad/vertico") "orderless" (orderless :type git :flavor melpa :host github :repo "oantolin/orderless") "embark" (embark :type git :flavor melpa :files ("embark.el" "embark-org.el" "embark.texi" "embark-pkg.el") :host github :repo "oantolin/embark") "embark-consult" (embark-consult :type git :flavor melpa :files ("embark-consult.el" "embark-consult-pkg.el") :host github :repo "oantolin/embark") "consult" (consult :type git :flavor melpa :host github :repo "minad/consult") "marginalia" (marginalia :type git :flavor melpa :host github :repo "minad/marginalia") "corfu" (corfu :type git :flavor melpa :files (:defaults "extensions/corfu-*.el" "corfu-pkg.el") :host github :repo "minad/corfu") "magit" (magit :type git :flavor melpa :files ("lisp/magit*.el" "lisp/git-rebase.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" "Documentation/magit.texi" "Documentation/AUTHORS.md" (:exclude "lisp/magit-libgit.el" "lisp/magit-libgit-pkg.el" "lisp/magit-section.el" "lisp/magit-section-pkg.el") "magit-pkg.el") :host github :repo "magit/magit") "git-commit" (git-commit :type git :flavor melpa :files ("lisp/git-commit.el" "lisp/git-commit-pkg.el" "git-commit-pkg.el") :host github :repo "magit/magit") "transient" (transient :type git :flavor melpa :host github :repo "magit/transient") "with-editor" (with-editor :type git :flavor melpa :host github :repo "magit/with-editor") "exec-path-from-shell" (exec-path-from-shell :type git :flavor melpa :host github :repo "purcell/exec-path-from-shell") "osx-lib" (osx-lib :type git :flavor melpa :host github :repo "raghavgautam/osx-lib") "projectile" (projectile :type git :flavor melpa :host github :repo "bbatsov/projectile") "treemacs" (treemacs :type git :flavor melpa :files (:defaults "Changelog.org" "icons" "src/elisp/treemacs*.el" "src/scripts/treemacs*.py" (:exclude "src/extra/*") "treemacs-pkg.el") :host github :repo "Alexander-Miller/treemacs") "cl-lib" nil "s" (s :type git :flavor melpa :host github :repo "magnars/s.el") "ace-window" (ace-window :type git :flavor melpa :host github :repo "abo-abo/ace-window") "avy" (avy :type git :flavor melpa :host github :repo "abo-abo/avy") "pfuture" (pfuture :type git :flavor melpa :host github :repo "Alexander-Miller/pfuture") "hydra" (hydra :type git :flavor melpa :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra") "lv" (lv :type git :flavor melpa :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra") "ht" (ht :type git :flavor melpa :host github :repo "Wilfred/ht.el") "cfrs" (cfrs :type git :flavor melpa :host github :repo "Alexander-Miller/cfrs") "posframe" (posframe :type git :flavor melpa :host github :repo "tumashu/posframe") "treemacs-projectile" (treemacs-projectile :type git :flavor melpa :files ("src/extra/treemacs-projectile.el" "treemacs-projectile-pkg.el") :host github :repo "Alexander-Miller/treemacs") "sly" (sly :type git :flavor melpa :files (:defaults "lib" "slynk" "contrib" "doc/images" (:exclude "sly-autoloads.el") "sly-pkg.el") :host github :repo "joaotavora/sly") "auto-complete" (auto-complete :type git :flavor melpa :files ("*.el" "dict" "auto-complete-pkg.el") :host github :repo "auto-complete/auto-complete") "popup" (popup :type git :flavor melpa :host github :repo "auto-complete/popup-el") "ac-sly" (ac-sly :type git :flavor melpa :host github :repo "qoocku/ac-sly") "lispy" (lispy :type git :flavor melpa :files (:defaults "lispy-clojure.clj" "lispy-clojure.cljs" "lispy-python.py" "lispy-pkg.el") :host github :repo "abo-abo/lispy") "iedit" (iedit :type git :flavor melpa :host github :repo "victorhge/iedit") "swiper" (swiper :type git :flavor melpa :files ("swiper.el" "swiper-pkg.el") :host github :repo "abo-abo/swiper") "ivy" (ivy :type git :flavor melpa :files (:defaults "doc/ivy-help.org" (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "ivy-pkg.el") :host github :repo "abo-abo/swiper") "zoutline" (zoutline :type git :flavor melpa :host github :repo "abo-abo/zoutline") "rainbow-delimiters" (rainbow-delimiters :type git :flavor melpa :host github :repo "Fanael/rainbow-delimiters") "emacs-w3m" nil "markdown-mode" (markdown-mode :type git :flavor melpa :host github :repo "jrblevin/markdown-mode") "aggressive-indent" (aggressive-indent :type git :flavor melpa :host github :repo "Malabarba/aggressive-indent-mode") "undo-tree" nil "queue" nil "which-key" (which-key :type git :flavor melpa :host github :repo "justbur/emacs-which-key") "crux" (crux :type git :flavor melpa :host github :repo "bbatsov/crux") "expand-region" (expand-region :type git :flavor melpa :host github :repo "magnars/expand-region.el") "org-ai" (org-ai :type git :flavor melpa :files (:defaults "snippets" "org-ai-pkg.el") :host github :repo "rksm/org-ai") "websocket" (websocket :type git :flavor melpa :host github :repo "ahyatt/emacs-websocket") "vertico-posframe" nil "golden-ratio" (golden-ratio :type git :flavor melpa :host github :repo "roman/golden-ratio.el"))) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "nongnu-elpa" nil "emacsmirror-mirror" nil "straight" nil "compat" (compat :type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git"))) "seq" (seq :type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git"))) "cl-lib" nil "emacs-w3m" nil "undo-tree" (undo-tree :type git :host github :repo "emacs-straight/undo-tree" :files ("*" (:exclude ".git"))) "queue" (queue :type git :host github :repo "emacs-straight/queue" :files ("*" (:exclude ".git"))) "vertico-posframe" (vertico-posframe :type git :host github :repo "emacs-straight/vertico-posframe" :files ("*" (:exclude ".git"))))) nongnu-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 4 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "emacs-w3m" nil)) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "emacs-w3m" `(emacs-w3m :type git :host github :repo "emacs-w3m/emacs-w3m" :pre-build ,(cl-letf (((symbol-function #'el-get-package-directory) (lambda (package) (straight--repos-dir (format "%S" package)))) (el-get-install-info (straight--el-get-install-info)) (el-get-emacs (straight--emacs-path)) (el-get-dir (straight--repos-dir))) (pcase system-type (`windows-nt `(("sh" "./autogen.sh") ("sh" "./configure") ("make"))) (_ `(("autoconf") ("./configure" ,(format "--with-emacs=%s" el-get-emacs)) ("make"))))) :files (:defaults)))) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "cl-lib" nil))))

("golden-ratio" "expand-region" "crux" "which-key" "queue" "undo-tree" "aggressive-indent" "markdown-mode" "emacs-w3m" "rainbow-delimiters" "zoutline" "ivy" "swiper" "iedit" "lispy" "ac-sly" "popup" "auto-complete" "sly" "treemacs-projectile" "cfrs" "ht" "lv" "hydra" "pfuture" "avy" "ace-window" "s" "cl-lib" "treemacs" "projectile" "osx-lib" "exec-path-from-shell" "with-editor" "transient" "git-commit" "magit" "corfu" "marginalia" "consult" "embark-consult" "embark" "orderless" "posframe" "vertico-posframe" "vertico" "deft" "seq" "compat" "magit-section" "emacsql" "dash" "org-roam" "org" "bind-key" "use-package" "emacs" "straight" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa")
